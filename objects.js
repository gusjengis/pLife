class Object {
    constructor(position, scale, rotation, color, model){
        ...
        if(this.model.SmoothLighting){
            for(i=0; i<this.model.vertices.length/3; i++){
                let p1 = [this.model.vertices[i*3], this.model.vertices[i*3+1], this.model.vertices[i*3+2]];
            ...
            for(i=0; i<this.model.vertices.length/18; i++){
                let p1 = [this.model.vertices[i*18], this.model.vertices[i*18+1], this.model.vertices[i*18+2]];
                let p2 = [this.model.vertices[i*18+3], this.model.vertices[i*18+4], this.model.vertices[i*18+5]];
                let p3 = [this.model.vertices[i*18+6], this.model.vertices[i*18+7], this.model.vertices[i*18+8]];
                let v1 = v3.sub(p2, p1);
                let v2 = v3.sub(p3, p1);
        ...
        this.model.vertices = new Float32Array(this.model.vertices);
        this.updateMatrix();
    }
...
class Camera {
    ...
    rotateH(rot){
        this.rot[1] += rot;
        // this.rot[0] -= rot*Math.sin(this.rot[1]);
        // this.rot[2] -= rot*(1-Math.sin(this.rot[1]));
